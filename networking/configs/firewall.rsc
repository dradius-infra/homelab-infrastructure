...
add chain=input action=accept protocol=udp dst-port=13231 comment="Allow WireGuard VPN Handshake"
...
add chain=input action=accept src-address=10.10.20.10 in-interface=VLAN20_MAIN comment="Allow Admin MacBook to manage router"
...
add chain=forward action=accept src-address=10.10.20.10 in-interface=VLAN20_MAIN comment="Allow Admin Mac to access all VLANs"
